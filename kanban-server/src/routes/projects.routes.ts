...
import { createProject, getMyProject, listMyProjects, updateProject, createProjectSchema, updateProjectSchema } from '../controllers/projects.controller';
...
projectsRoutes.get('/', listMyProjects);
